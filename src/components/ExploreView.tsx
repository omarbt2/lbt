...
import { Search, Mic, Heart, Star, Compass, Hash, Sparkles } from 'lucide-react';
...
export default function ExploreView({ onSelectHashtag, onPostSelect, onViewProfile }: ExploreViewProps) {
